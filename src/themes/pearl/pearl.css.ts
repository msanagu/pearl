...
export const pearlLightThemeClass = createTheme(vars, {
  color: {
    ...
    positive: { surface: pearlSentiment.algae[100], border: pearlSentiment.algae[200], text: pearlSentiment.algae[700], icon: `color-mix(in srgb, ${pearlSentiment.algae[500]} 65%, ${vars.color.textSubtle})`, fill: pearlSentiment.algae[400], onFill: pearlSentiment.algae[800] },
    negative: { surface: pearlSentiment.coral[100], border: pearlSentiment.coral[200], text: pearlSentiment.coral[700], icon: `color-mix(in srgb, ${pearlSentiment.coral[500]} 65%, ${vars.color.textSubtle})`, fill: pearlSentiment.coral[400], onFill: pearlSentiment.coral[800] },
    warn: { surface: pearlSentiment.sunlight[100], border: pearlSentiment.sunlight[300], text: pearlSentiment.sunlight[700], icon: `color-mix(in srgb, ${pearlSentiment.sunlight[500]} 65%, ${vars.color.textSubtle})`, fill: pearlSentiment.sunlight[400], onFill: pearlSentiment.sunlight[800] },
    info: { surface: pearlSentiment.tide[100], border: pearlSentiment.tide[200], text: pearlSentiment.tide[700], icon: `color-mix(in srgb, ${pearlSentiment.tide[500]} 65%, ${vars.color.textSubtle})`, fill: pearlSentiment.tide[400], onFill: pearlSentiment.tide[800] },
  },
  radius: pearlRadius,
  space: pearlSpace,
...
export const pearlDarkThemeClass = createTheme(vars, {
  color: {
    ...
    positive: { surface: pearlSentiment.algae[800], border: pearlSentiment.algae[600], text: pearlSentiment.algae[300], icon: `color-mix(in srgb, ${pearlSentiment.algae[400]} 65%, ${vars.color.textSubtle})`, fill: pearlSentiment.algae[600], onFill: pearlSentiment.algae[100] },
    negative: { surface: pearlSentiment.coral[800], border: pearlSentiment.coral[600], text: pearlSentiment.coral[300], icon: `color-mix(in srgb, ${pearlSentiment.coral[400]} 65%, ${vars.color.textSubtle})`, fill: pearlSentiment.coral[600], onFill: pearlSentiment.coral[100] },
    warn: { surface: pearlSentiment.sunlight[800], border: pearlSentiment.sunlight[600], text: pearlSentiment.sunlight[200], icon: `color-mix(in srgb, ${pearlSentiment.sunlight[400]} 65%, ${vars.color.textSubtle})`, fill: pearlSentiment.sunlight[600], onFill: pearlSentiment.sunlight[100] },
    info: { surface: pearlSentiment.tide[800], border: pearlSentiment.tide[600], text: pearlSentiment.tide[300], icon: `color-mix(in srgb, ${pearlSentiment.tide[400]} 65%, ${vars.color.textSubtle})`, fill: pearlSentiment.tide[600], onFill: pearlSentiment.tide[100] },
  },
  radius: pearlRadius,
  space: pearlSpace,
  controlHeight: pearlControlHeight,
...
// [data-inverse] scoped container — see inverse.ts. Every value is the other
// mode's own already-checked value for that key.
