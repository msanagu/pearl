...
export const southSeaLightThemeClass = createTheme(vars, {
  color: {
    ...
    positive: { surface: southSeaSentiment.seaMoss[100], border: southSeaSentiment.seaMoss[200], text: southSeaSentiment.seaMoss[700], icon: `color-mix(in srgb, ${southSeaSentiment.seaMoss[500]} 65%, ${vars.color.textSubtle})`, fill: southSeaSentiment.seaMoss[400], onFill: southSeaSentiment.seaMoss[800] },
    negative: { surface: southSeaSentiment.anemone[100], border: southSeaSentiment.anemone[200], text: southSeaSentiment.anemone[600], icon: `color-mix(in srgb, ${southSeaSentiment.anemone[500]} 65%, ${vars.color.textSubtle})`, fill: southSeaSentiment.anemone[400], onFill: southSeaSentiment.anemone[800] },
    warn: { surface: southSeaSentiment.shell[100], border: southSeaSentiment.shell[200], text: southSeaSentiment.shell[700], icon: `color-mix(in srgb, ${southSeaSentiment.shell[500]} 65%, ${vars.color.textSubtle})`, fill: southSeaSentiment.shell[400], onFill: southSeaSentiment.shell[800] },
    info: { surface: southSeaSentiment.pacific[100], border: southSeaSentiment.pacific[200], text: southSeaSentiment.pacific[700], icon: `color-mix(in srgb, ${southSeaSentiment.pacific[500]} 65%, ${vars.color.textSubtle})`, fill: southSeaSentiment.pacific[400], onFill: southSeaSentiment.pacific[800] },
  },
...
export const southSeaDarkThemeClass = createTheme(vars, {
  color: {
    ...
    positive: { surface: southSeaSentiment.seaMoss[800], border: southSeaSentiment.seaMoss[600], text: southSeaSentiment.seaMoss[300], icon: `color-mix(in srgb, ${southSeaSentiment.seaMoss[400]} 65%, ${vars.color.textSubtle})`, fill: southSeaSentiment.seaMoss[600], onFill: southSeaSentiment.seaMoss[100] },
    negative: { surface: southSeaSentiment.anemone[800], border: southSeaSentiment.anemone[700], text: southSeaSentiment.anemone[300], icon: `color-mix(in srgb, ${southSeaSentiment.anemone[400]} 65%, ${vars.color.textSubtle})`, fill: southSeaSentiment.anemone[600], onFill: southSeaSentiment.anemone[100] },
    warn: { surface: southSeaSentiment.shell[800], border: southSeaSentiment.shell[600], text: southSeaSentiment.shell[300], icon: `color-mix(in srgb, ${southSeaSentiment.shell[400]} 65%, ${vars.color.textSubtle})`, fill: southSeaSentiment.shell[600], onFill: southSeaSentiment.shell[100] },
    info: { surface: southSeaSentiment.pacific[800], border: southSeaSentiment.pacific[600], text: southSeaSentiment.pacific[300], icon: `color-mix(in srgb, ${southSeaSentiment.pacific[400]} 65%, ${vars.color.textSubtle})`, fill: southSeaSentiment.pacific[600], onFill: southSeaSentiment.pacific[100] },
  },
  radius: southSeaRadius,
  space: southSeaSpace,
  controlHeight: southSeaControlHeight,
